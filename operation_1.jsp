...
<title>Insert title here</title>
 ...
 <link href="./css/operation_1.chunk.css" rel="stylesheet" type="text/css">
                            ...
                            <div class="main">
                                <div class="left">
                                    <div class="left_nav_type2">
                                        ...
                                        <ul class="left_nav_menu">
                                            ...
                                            <li><a class="active" id="scrollMain" href="/help/inquiry/form.hm"><span>일반 문의</span></a></li>
                                ...
                                <section class="left_main">
                                    <div class="comunity_content_title_area_contact">
                                        <ul class="inquiry_tab"><a class="active" href="/help/inquiry/list.hm">
                                                <li>문의/안내 내역</li>
                                            </a><a class="" href="/help/inquiry/form.hm">
                                                <li>문의하기</li>
                                            </a></ul>
                                    </div>
                                    <ul class="inquiry_list">
                                        <h1>헬로마켓 - 100% 안전한 중고거래 장터</h1>
                                        <h2>일반문의 리스트 페이지</h2>
                                        <div class="inquiry_empty"><img src="https://ccimage.hellomarket.com/web/2019/inquiry/img_blank_1to1.png" alt="문의없음 이미지">
                                            <div class="inquiry_empty_title">문의하신 내용이 없습니다.</div>
                                        </div>
                                    </ul>
                                </section>
                            </div>
