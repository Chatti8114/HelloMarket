                            ...
                            <div class="main">
                                ...
                                <section class="left_main">
                                    <div class="event_list_area">
                                        <ul class="">
                                            <li class="event_list list_left"><a class="link" href="https://www.hellomarket.com/post/198890?status=close">
                                                    <div class="event_row">
                                                        <div class="event_close"></div><img class="event_img" src="https://ccimg.hellomarket.com/images/2019/document/11/20/11/2839_198890_1.png?size=s6" alt="헬페데이 선착순 쿠폰 발급">
                                                    </div>
                                                </a></li>
                                            <li class="event_list list_right"><a class="link" href="https://www.hellomarket.com/post/198880?status=close">
                                                    <div class="event_row">
                                                        <div class="event_close"></div><img class="event_img" src="https://ccimg.hellomarket.com/images/2019/document/10/31/11/5829_198880_1.jpg?size=s6" alt="GS편의점택배 11월 이벤트">
                                                    </div>
                                                </a></li>
                                            <li class="event_list list_left"><a class="link" href="https://www.hellomarket.com/post/198879?status=close">
                                                    <div class="event_row">
                                                        <div class="event_close"></div><img class="event_img" src="https://ccimg.hellomarket.com/images/2019/document/10/31/11/5619_198879_1.png?size=s6" alt="CU편의점택배 11월 이벤트">
                                                    </div>
                                                </a></li>
                                        </ul>
                                    </div>
                ...
                <div class="footer_top">
                    <div class="f_wrapper">
                        <ul class="f_left">
                            ...
                            <li><a class="link_info" href="Helpcenter.html">FAQ</a><span class="list_space"></span></li>
                            <li><a class="link_info" href="https://www.hellomarket.com/protection.hm">이용약관</a><span class="list_space"></span></li>
