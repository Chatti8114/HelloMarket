...
<title>Insert title here</title>
 ...
 <link href="./css/operation_2.css" rel="stylesheet" type="text/css">
                            ...
                            <div class="main">
                                <div class="left">
                                    <div class="left_nav_type2">
                                        ...
                                        <ul class="left_nav_menu">
                                            <li><a href="helpcenter.jsp"><span>자주묻는질문</span></a></li>
                                            <li><a class="active" id="scrollMain" href="operation_1.jsp"><span>일반 문의</span></a></li>
                                ...
                                <section class="left_main">
                                    <div class="comunity_content_title_area_contact">
                                        <ul class="inquiry_tab"><a class="" href="operation_1.jsp">
                                                <li>문의/안내 내역</li>
                                            </a><a class="active" href="operation_2.jsp">
                                                <li>문의하기</li>
                                            </a></ul>
                                    </div>
                                    <div class="mail_view">
                                            ...
                                            <table class="inquiry_table inquiry_auth_table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="field"><input type="text" class="" placeholder="이름을 입력해주세요." value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">*연락처</td>
                                                        <td class="field"><input type="text" class="" placeholder="연락처를 입력해주세요.(숫자만)" value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">*이메일</td>
                                                        <td class="field"><input type="text" class="" placeholder="이메일을 입력해주세요." value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">*유형</td>
                                                        <td class="field"><select id="" class="commonSelectbox">
                                                                <option value="" disabled="">카테고리 선택</option>
                                                                <option value="ICA0000">개인정보&amp;회원계정</option>
                                                                <option value="IDA0000">신고</option>
                                                                <option value="IBA0000">배송</option>
                                                                <option value="IEA0000">오류</option>
                                                                <option value="IIA0000">중고차(개인)</option>
                                                                <option value="IIB0000">중고차(딜러)</option>
                                                                <option value="IJA0000">광고센터</option>
                                                                <option value="IFA0000">제안하기</option>
                                                                <option value="IGA0000">기타</option>
                                                            </select></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="field photo_field" colspan="2"><textarea placeholder="내용 입력" class="textarea" rows="7"></textarea></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <ul class="btn_wrapper btn_wrapper_center">
                                            ...
                                            <li><a class="btn list_btn" href="/help/escrow/list.hm">목록</a></li>
                                        </ul>
                                    </div>
                                </section>
                            </div>
