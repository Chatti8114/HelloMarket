...
<title>Insert title here</title>
  <link href="../css/helpcenter1.css" rel="stylesheet">
  <link href="../css/helpcenter2.css" rel="stylesheet">
      ...
      <header class="">
          ...
          <section class="header_top">
              <div class="header_logo header_logo_s">
                  <div class="log_box"><a href="https://www.hellomarket.com/"><img src="./안녕마켓logo1.png" class="logo" alt="안녕마켓"><img src="./안녕마켓logo2.png" class="mobile_logo" alt="안녕마켓"></a></div>
<%
	if(userId == null ){
%>
                  <div class="btn_box"><a class="btn_login_box" href="login.html"><button class="login_btn">로그인</button></a><a class="btn_signup_box" href="signup.html"><button class="signup_btn">회원가입</button></a><a href="/msearch">
 ...
 <div style="display: none;">
                ...
                <li class="gnb_my_list_last">로그아웃</li>
                  ...
                  <div class="header_search" id="tebas">
                      <div class="com_search_box">
                          <div>
                              <div><input type="text" class="com_search" placeholder="어떤 상품을 찾고 계세요?" value="" style="border-bottom: 1px solid rgb(158, 164, 170);">
                                  <div class="search_icon_box">
                                      <div class="search_icon">
                                          <div class="search_circle" style="border-color: rgb(158, 164, 170);"></div>
                                          <div class="search_rectangle" style="border-color: rgb(158, 164, 170);"></div>
                                      </div>
                                  </div>
                              </div>
                          </div>
          ...
          <section class="header_cat">
              <div class="header_wrapper">
                  <div>
                      <div class="btn_box header_wrapper_sub"><input type="checkbox" class="cat_checkbox chkbox1"><i class="arrow"></i><span for="cat_checkbox" class="selectbox">카테고리</span>
                          <div></div>
                      </div>
                  </div>
                  <div class="sellimg_sub_box header_wrapper_sub">
                      <div class="selling_bot"><img src="https://ccimage.hellomarket.com/web/2019/header/ico_sell_camera_x2.png" alt="판매하기 이미지" class="selling_bot_img"><span class="selling_bot_text">판매하기</span></div>
                  </div>
                  <div class="link_box header_wrapper_sub">
                      <ul>
                          <li><a href="Event.html">이벤트</a></li>
                          <li><a href="Helpcenter.html">헬프센터</a></li>
                          <li><a href="https://ad.hellomarket.com" target="_blank" rel="noopener noreferrer"><img src="https://ccimage.hellomarket.com/web/2019/header/ico_category_AD_x2.png" alt="광고센터 아이콘이미지">광고센터</a></li>
                      </ul>
                  </div>
              </div>
          </section>
                              ...
                              <div class="left">
                                  <div class="left_nav_type2">
                                      ...
                                      <ul class="left_nav_menu">
                                          ...
                                          <li><a href="operation_1.jsp"><span>일반 문의</span></a></li>
      ...
      <div class="footer">
          <div class="footer_area">
              <div class="footer_top">
                  <div class="f_wrapper">
                      <ul class="f_left">
                          <li><a href="http://company.hellomarket.com" class="link_info" target="_blank" rel="noopener noreferrer">관리자모드</a></li>
